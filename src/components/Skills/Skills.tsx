...
import {
  ...
  SiSocketdotio, SiPostman, SiLinux, SiJsonwebtokens,
} from "react-icons/si";
import { SiFigma } from "react-icons/si";
import {
  LuShieldCheck, LuDatabase, LuPlug, LuNetwork,
  LuLayoutTemplate, LuWrench, LuCode, LuPenTool, LuFramer, LuTable2,
} from "react-icons/lu";
...
const SKILLS: Skill[] = [
  ...
  { name: "Responsive",    icon: LuLayoutTemplate, color: "#6366f1", bg: "#eef0ff" },
