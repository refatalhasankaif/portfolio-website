...
const EMAILJS_SERVICE_ID  = "service_oednwvq" as string;
const EMAILJS_TEMPLATE_ID = "template_w59xl51" as string;
const EMAILJS_PUBLIC_KEY  = "rM6Ie_Pd-HhbknAzh" as string;
