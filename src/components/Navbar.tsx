                    ...
                    `}
                        ...
                        <div className="flex items-center gap-0.5 sm:gap-1 shrink-0">
                            ...
                            <div className="hidden md:flex items-center gap-0.5">
                                <a
                                    href="https://www.linkedin.com/in/refatkaif/"
                                    target="_blank"
                            ...
                            >
                                <div className="w-5 h-4 flex flex-col justify-between">
                                    <span
                                        className={`block h-0.5 bg-current rounded-full transition-all duration-300 origin-center ${menuOpen ? "rotate-45 translate-y-1.75" : ""
                                            }`}
                                    />
                                    <span
                                    ...
                                    />
                                    <span
                                        className={`block h-0.5 bg-current rounded-full transition-all duration-300 origin-center ${menuOpen ? "-rotate-45 -translate-y-2.25" : ""
                                            }`}
                                    />
                                </div>
                            </button>
